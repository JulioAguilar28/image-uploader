...
function InputView({ error = false, errorLabel, ...attributes }: Props) {
  ...
  return (
    <label className="w-full">
      <input
        {...attributes}
        className={`w-full border ${borderClasses} opacity-70 rounded p-1 text-[#4F4F4F] focus:outline-none focus:border-[#2F80ED]`}
      />
